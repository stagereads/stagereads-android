...
import com.econify.stagereads.shop.BillingService.RequestPurchase;
import com.econify.stagereads.shop.BillingService.RestoreTransactions;
import com.econify.stagereads.shop.Consts.PurchaseState;
import com.econify.stagereads.shop.Consts.ResponseCode;
...
public class ResponseHandler {
    ...
    public static void purchaseResponse(
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                ShopDB shopDB = ShopDB.getShopDB(context);
                if (purchaseState == PurchaseState.PURCHASED) {
                    shopDB.setSubscribed(productId);
                }
                else if(purchaseState == PurchaseState.EXPIRED) {
                    shopDB.setUnsubscribed(productId);
                }
